...
export function TestCasesTab(props: TestCasesTabProps) {
  ...
  return (
    <Card className="flex w-full  border-muted-foreground/20 overflow-y-scroll h-[600px]">
            ...
            <div className="flex-1 p-6 flex flex-col gap-6 min-h-0 overflow-y-auto">
              <div className="flex flex-col space-y-2">
                ...
                <Textarea
                  ...
                  className="min-h-[200px] font-mono text-sm resize focus-visible:ring-1 focus-visible:ring-ring border-muted-foreground/20"
                />
              </div>
              <div className="flex flex-col space-y-2">
                <label className="text-sm font-semibold text-muted-foreground">
