  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6">
        ...
        <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-9 after:flex after:items-center after:border-t">
