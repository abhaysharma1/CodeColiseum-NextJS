...
const initialPerformanceConstraints: PerformanceConstraints = {
  cppTimeLimitMs: 1000,
...
const initialState: ProblemEditorState = {
  ...
  status: "DRAFT",
  hidden: false,
  performanceConstraints: initialPerformanceConstraints,
...
export default function CreateProblemPage() {
  ...
  const [state, setState] = useState<ProblemEditorState>(() => ({
    ...initialState,
    description: NEW_PROBLEM_TEMPLATE,
  }));
  ...
  return (
    <div className="h-full w-full flex flex-col">
      <div className="w-full">
        <SiteHeader name="Create Problem" />
      </div>
