...
function CodingEditor({
  ...
  const { theme, setTheme } = useTheme(); // dark/light theme
  const { selected, setThemeName } = useCustomTheme(); // shadCN Theme
        ...
        >
          ...
          <div className="w-full h-12 flex-shrink-0 bg-background flex justify-between items-center px-3 gap-3">
            <div className="flex gap-2.5">
              ...
              <Button onClick={resetCode} variant={"outline"} className="h-8.5">
                Clear
              </Button>
            </div>
