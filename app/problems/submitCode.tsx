    ...
    return (
      <div className="p-4">
        <div className="animate-fade-right animate-once">
          <div className="text-yellow-600 text-xl font-semibold mb-2">⚠️ Submission Error</div>
          <Card>
            <CardHeader>
    ...
    <div className="p-4">
      ...
      <div className="animate-fade-right animate-once mb-4">
        {results.status === "ACCEPTED" ? (
          ...
          <div className="text-yellow-600 text-2xl font-bold">⚠ Time Complexity Not Optimal</div>
        ) : (
      ...
      <div>
        ...
        {results.totalMemoryUsed !== undefined && results.totalTimeTaken !== undefined && (
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-sm text-foreground/60">Memory Used</div>
        ...
        {(results.status === "ACCEPTED" || results.status === "BAD_SCALING") && 
         results.noOfPassedCases !== undefined && 
         results.totalCases !== undefined && (
        ...
        {results.status === "BAD_ALGORITHM" && results.failedCaseExecutionDetails && (
          <div className="animate-fade-up animate-once">
            <Card>
              <CardHeader>
                <CardTitle>Failed Test Case</CardTitle>
                <CardDescription>
                  {results.noOfPassedCases !== undefined && results.totalCases !== undefined 
                    ? `Passed ${results.noOfPassedCases} out of ${results.totalCases} test cases`
              ...
              <CardContent>
                <div className="rounded-md overflow-hidden">
                  <div className="p-3 px-4 dark:bg-background/40 bg-foreground/10 border-b border-foreground/10">
                    <div className="text-xs font-semibold text-foreground/60 mb-1">INPUT</div>
                    <pre className="whitespace-pre-wrap font-mono text-sm">
                      {results.failedCase?.stdin}
                    </pre>
                  </div>
                  <div className="p-3 px-4 dark:bg-background/40 bg-foreground/10 border-b border-foreground/10">
                    <div className="text-xs font-semibold text-foreground/60 mb-1">EXPECTED OUTPUT</div>
                    <pre className="whitespace-pre-wrap font-mono text-sm">
